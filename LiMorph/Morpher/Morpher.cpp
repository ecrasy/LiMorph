...
#include "../Lua/ClickMountMorphing.lua"
    ...
    int __cdecl Morpher::morphItemCallback(uintptr_t lua_state) {
        ...
        if (top) {
            int item = static_cast<int>(WoWFunctions::luaToNumber(lua_state, top - 2));
            int item_id = static_cast<int>(WoWFunctions::luaToNumber(lua_state, top - 1));
            int item_version = static_cast<int>(WoWFunctions::luaToNumber(lua_state, top));
    ...
    int __cdecl Morpher::morphEnchantCallback(uintptr_t lua_state) {
        int top = WoWFunctions::luaGetTop(lua_state);
        if (top) {
            int item = static_cast<int>(WoWFunctions::luaToNumber(lua_state, top - 1));
            int enchant_id = static_cast<int>(WoWFunctions::luaToNumber(lua_state, top));
    ...
    int __cdecl Morpher::morphMountCallback(uintptr_t lua_state) {
        int top = WoWFunctions::luaGetTop(lua_state);
        if (top) {
            int mount_id = static_cast<int>(WoWFunctions::luaToNumber(lua_state, top));
